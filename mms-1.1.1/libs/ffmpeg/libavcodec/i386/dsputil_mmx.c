...
DECLARE_ALIGNED_8 (const uint64_t __attribute__(( visibility ("protected") )), ff_pw_8  ) = 0x0008000800080008ULL;
DECLARE_ALIGNED_8 (const uint64_t __attribute__(( visibility ("protected") )), ff_pw_15 ) = 0x000F000F000F000FULL;
DECLARE_ALIGNED_16(const xmm_t __attribute__(( visibility ("protected") )),    ff_pw_16 ) = {0x0010001000100010ULL, 0x0010001000100010ULL};
...
DECLARE_ALIGNED_8 (const uint64_t __attribute__(( visibility ("protected") )), ff_pw_64 ) = 0x0040004000400040ULL;
