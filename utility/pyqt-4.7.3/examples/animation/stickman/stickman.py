...
class StickMan(QtGui.QGraphicsObject):
    ...
    penColor = QtCore.pyqtProperty(QtGui.QColor, getPenColor, setPenColor)
    ...
    fillColor = QtCore.pyqtProperty(QtGui.QColor, getFillColor, setFillColor)
    ...
    isDead = QtCore.pyqtProperty(bool, getIsDead, setIsDead)
