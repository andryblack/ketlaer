...
bool IPV4Cidr::isMember(struct in_addr &addr)
{
...
bool IPV4Cidr::isMember(struct sockaddr *saddr)
{
...
unsigned IPV4Cidr::getMask(const char *cp)
{
        unsigned dcount = 0;
        const char *gp = cp;
...
bool IPV6Cidr::isMember(struct in6_addr &addr)
{
...
bool IPV6Cidr::isMember(struct sockaddr *saddr)
{
...
unsigned IPV6Cidr::getMask(const char *cp)
{
