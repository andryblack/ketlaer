...
_pkg_config = {
    ...
    'default_mod_dir':  '/usr/local/lib/python2.6/site-packages',
    'default_sip_dir':  '/usr/local/share/sip',
    'platform':         'linux-g++',
    'py_conf_inc_dir':  '/usr/local/include/python2.6',
    'py_inc_dir':       '/usr/local/include/python2.6',
    'py_lib_dir':       '/usr/local/lib/python2.6/config',
    'py_version':       0x020605,
    'sip_bin':          '/usr/local/bin/sip',
    'sip_config_args':  '',
    'sip_inc_dir':      '/usr/local/include/python2.6',
    'sip_mod_dir':      '/usr/local/lib/python2.6/site-packages',
