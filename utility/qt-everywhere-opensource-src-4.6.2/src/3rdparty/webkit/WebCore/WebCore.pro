...
#KETLAER defines.
#get it smaller.
DEFINES += ENABLE_SVG=0
DEFINES += ENABLE_SVG=0  
DEFINES += ENABLE_RUBY=0
DEFINES += ENABLE_VIDEO=0
DEFINES += ENABLE_NETSCAPE_PLUGIN_API=0
DEFINES += ENABLE_VIDEO=0
DEFINES += ENABLE_XSLT=0
DEFINES += ENABLE_CHANNEL_MESSAGING=0
DEFINES += ENABLE_JAVASCRIPT_DEBUGGER=0
DEFINES += ENABLE_SQLITE=0
DEFINES += ENABLE_DATABASE=0
DEFINES += ENABLE_EVENTSOURCE=0
DEFINES += ENABLE_OFFLINE_WEB_APPLICATIONS=0
DEFINES += ENABLE_DOM_STORAGE=0
DEFINES += ENABLE_ICONDATABASE=0
DEFINES += ENABLE_SHARED_WORKERS=0
DEFINES += ENABLE_WORKERS=0
DEFINES += ENABLE_WML=0
DEFINES += ENABLE_XPATH=0
DEFINES += ENABLE_XBL=0
