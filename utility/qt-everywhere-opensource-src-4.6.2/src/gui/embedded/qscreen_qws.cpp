...
/*!
    ...
    identifier.
*/
QScreen::QScreen(int display_id, ClassId classId, PixelType pt)
    : screencols(0), data(0), entries(0), entryp(0), lowest(0),
      w(0), lstep(0), h(0), d(1), pixeltype(pt), grayscale(false),
...
QScreen::QScreen(int display_id, PixelType pt)
    : screencols(0), data(0), entries(0), entryp(0), lowest(0),
      w(0), lstep(0), h(0), d(1), pixeltype(pt), grayscale(false),
      dw(0), dh(0), size(0), mapsize(0), displayId(display_id),
